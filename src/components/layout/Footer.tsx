      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-display font-bold text-lg">Pyramid</span>
                <span className="font-display font-medium text-sm opacity-80 block">Consulting & IT Learnings</span>
              </div>
            </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-primary-foreground/70 text-sm">
                  Regus Centre Midtown, iLabs, Hyderabad Technology Park, Inorbit Mall Road, Hyderabad – 500081
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-accent shrink-0" />
                <a href="tel:+919553419349" className="text-primary-foreground/70 hover:text-accent transition-colors text-sm">
                  +91 95534 19349
                </a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-primary-foreground/60 text-sm">
            © {new Date().getFullYear()} Pyramid Consulting & IT Learnings. All rights reserved.
          </p>
